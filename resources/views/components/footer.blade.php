<footer class="bg-slate-900 mt-20">
  <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="flex justify-center sm:justify-start text-white font-bold text-3xl">
          <h1>Job<span class="text-green-700">Pulse</span></h1>
        </div>
        ...
        <ul class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
          <li>
            <a
              ...
              target="_blank"
              class="text-green-700 transition hover:text-teal-500/75"
            >
    ...
    <div class="pt-6 mt-12 border-t border-gray-800">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm text-gray-400">
          ...
          <a
            class="inline-block text-green-700 underline transition hover:text-teal-500/75"
            href="/"
          >
            Terms & Conditions
          </a>
